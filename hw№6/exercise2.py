...
arr = list_creation(list_length)
new_list = sum([n for i, n in enumerate(arr) if i % 2 != 0])


print(f"{arr} -> сумма элементов списка стоящих на нечётной позиции равно: {new_list}")
